...
public class RemoteTest {
	...
	for (int i = 0; i < 10; ++i) {
	    ...
	    RemoteRepository remoteRepo = (RemoteRepository) pair[1].receive();
	    Repository clientRepo = ClientRepository.from(remoteRepo);
	    Storage<StorableTestBasic> storage = clientRepo.storageFor(StorableTestBasic.class);
	    ...
	    Storage<StorableTestBasic> storage1 = clientRepo.storageFor(StorableTestBasic.class);;
	...
	try {
	    ...
	    StorableTestBasic stbInternal = storage.prepare();
	    stbInternal.setId(2);
